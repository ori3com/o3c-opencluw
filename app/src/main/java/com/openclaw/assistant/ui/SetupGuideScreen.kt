                ...
                SetupStep.Connection -> ConnectionStep(
                    ...
                    onNext = {
                        ...
                        if (connectionMode == ConnectionMode.SetupCode) {
                            ...
                            Log.d("SetupGuide", "Setup code decoded: decoded=${decoded != null}, hasToken=${decoded?.token != null}, hasBootstrapToken=${decoded?.bootstrapToken != null}, hasPassword=${decoded?.password != null}")
                            if (decoded != null) {
                                ...
                                if (parsed != null) {
                                    ...
                                    // Save credentials and clear stale fields. Only one auth type is valid.
                                    when {
